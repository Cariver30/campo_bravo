...
class LoyaltyAdminController extends Controller
{
    ...
    public function storeServer(Request $request)
    {
        ...
        Mail::to($user->email)->send(new ServerInvitationMail($user, $token));

        return back()->with('success', 'Mesero invitado. Revisa su correo.');
    }

    public function resendInvitation(User $user)
    {
        abort_unless($user->isServer(), 403);
    ...
    public function toggleServer(User $user)
    {
        ...
        return back()->with('success', $user->active ? 'Mesero activado.' : 'Mesero bloqueado.');
    }
    ...
    public function destroyServer(User $user)
    {
        ...
        return back()->with('success', 'Mesero eliminado.');
    }
}
