...
$foodPairings = FoodPairing::all();
    ...
    public function updateBackground(Request $request)
    {
        $request->validate([
            ...
            'floating_bar_bg_menu' => 'nullable|string|max:255',
            'floating_bar_button_color_menu' => 'nullable|string|max:255',
            'floating_bar_bg_cocktails' => 'nullable|string|max:255',
            'floating_bar_button_color_cocktails' => 'nullable|string|max:255',
            'floating_bar_bg_wines' => 'nullable|string|max:255',
            'floating_bar_button_color_wines' => 'nullable|string|max:255',
            ...
            'wine_filter_panel_bg_color' => 'nullable|string|max:255',
            'wine_filter_panel_text_color' => 'nullable|string|max:255',
            'wine_filter_input_bg_color' => 'nullable|string|max:255',
            'wine_filter_input_text_color' => 'nullable|string|max:255',
            'wine_filter_chip_bg_color' => 'nullable|string|max:255',
            'wine_filter_chip_text_color' => 'nullable|string|max:255',
        ...
        $settings->floating_bar_bg_menu = $request->input('floating_bar_bg_menu', $settings->floating_bar_bg_menu);
        $settings->floating_bar_button_color_menu = $request->input('floating_bar_button_color_menu', $settings->floating_bar_button_color_menu);
        $settings->floating_bar_bg_cocktails = $request->input('floating_bar_bg_cocktails', $settings->floating_bar_bg_cocktails);
        $settings->floating_bar_button_color_cocktails = $request->input('floating_bar_button_color_cocktails', $settings->floating_bar_button_color_cocktails);
        $settings->floating_bar_bg_wines = $request->input('floating_bar_bg_wines', $settings->floating_bar_bg_wines);
        $settings->floating_bar_button_color_wines = $request->input('floating_bar_button_color_wines', $settings->floating_bar_button_color_wines);
        ...
        $settings->wine_filter_panel_bg_color = $request->input('wine_filter_panel_bg_color', $settings->wine_filter_panel_bg_color);
        $settings->wine_filter_panel_text_color = $request->input('wine_filter_panel_text_color', $settings->wine_filter_panel_text_color);
        $settings->wine_filter_input_bg_color = $request->input('wine_filter_input_bg_color', $settings->wine_filter_input_bg_color);
        $settings->wine_filter_input_text_color = $request->input('wine_filter_input_text_color', $settings->wine_filter_input_text_color);
        $settings->wine_filter_chip_bg_color = $request->input('wine_filter_chip_bg_color', $settings->wine_filter_chip_bg_color);
        $settings->wine_filter_chip_text_color = $request->input('wine_filter_chip_text_color', $settings->wine_filter_chip_text_color);
