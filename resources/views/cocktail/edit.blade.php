...
<div class="container mt-5">
    ...
    <form action="{{ route('cocktails.update', $cocktail->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3 form-check">
            <input type="checkbox" class="form-check-input" id="featured_on_cover" name="featured_on_cover" value="1" {{ old('featured_on_cover', $cocktail->featured_on_cover) ? 'checked' : '' }}>
