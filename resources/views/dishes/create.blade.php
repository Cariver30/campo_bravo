...
<head>
    ...
    <title>Crear Plato - Panel de Administración</title>
...
<div class="container mt-5">
    ...
    <form method="POST" action="{{ route('dishes.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-check mb-4">
            ...
            <label class="form-check-label" for="featured_on_cover">Destacar en la portada (usa el nombre de la categoría activada)</label>
        </div>
