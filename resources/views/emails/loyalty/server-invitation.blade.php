    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 560px; margin: 0 auto; background: #ffffff; border-radius: 16px; overflow: hidden;">
        <tr>
            <td style="padding: 32px;">
                <p style="text-transform: uppercase; letter-spacing: 0.3em; font-size: 12px; color: #a16207; margin-bottom: 16px;">{{ config('app.name', 'CampoBravo') }} · Accesos</p>
                ...
                <p style="color: #4b5563; line-height: 1.5; margin-bottom: 24px;">
                    Fuiste invitado como mesero para gestionar check-ins del programa de puntos. Para activar tu cuenta y definir una contraseña segura, haz clic en el botón:
                </p>
